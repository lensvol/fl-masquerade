...
Manage multiple 'personas' in Fallen London via in-game interface.

_NB: This extension is **not** yet whitelisted by Failbetter Games. Use at your own risk!_ 

Grab it here:
* [Releases page](https://github.com/lensvol/fl-masquerade/releases) (most up-to-date, see below for instructions)
* [Google Web Store](https://chrome.google.com/webstore/detail/fl-masquerade/aphfpnlcbhnaipmakigbajglopeiodfb)
